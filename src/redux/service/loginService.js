...
export const studentLoginApi = createAsyncThunk('student/loginApi', async (data) => {
    ...
    return await Axios.post('https://eduprodfirstphasebackend-env.eba-fi5wgagu.us-east-1.elasticbeanstalk.com/api/student/login', data);
...
export const teacherLoginApi = createAsyncThunk('teacher/teacherLoginSlice', async (data) => {
    ...
    return await Axios.post('https://eduprodfirstphasebackend-env.eba-fi5wgagu.us-east-1.elasticbeanstalk.com/api/teacher/login', data);
...
export const getStudentData = createAsyncThunk('student/studentData', async(data) => {
    ...
    return await Axios.post('https://eduprodfirstphasebackend-env.eba-fi5wgagu.us-east-1.elasticbeanstalk.com/api/student/data', data);
...
export const getTeacherData = createAsyncThunk('teacher/teacherData', async(data) => {
    ...
    return await Axios.post('https://eduprodfirstphasebackend-env.eba-fi5wgagu.us-east-1.elasticbeanstalk.com/api/teacher/data', data);
