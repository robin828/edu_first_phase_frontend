...
export const getTeacherDashboard = async (body) => {
    return await Axios.get(`http://myonlineedu.ap-south-1.elasticbeanstalk.com//api/teacher/dashboard?userName=${body.userName}`, {
        headers: {
            'auth_token': localStorage.getItem('auth_token')
          }
    });
...
//     console.log(body, "@@##");
//     console.log("hii")
//     return await Axios.put(`http://myonlineedu.ap-south-1.elasticbeanstalk.com///api/teacher/assign`, body, {headers})
// }
...
export const assignQuestionsToStudents = createAsyncThunk('teacher/assign', async (data) => {
    ...
    return await Axios.put(`http://myonlineedu.ap-south-1.elasticbeanstalk.com/api/teacher/assign`, data, {headers})
