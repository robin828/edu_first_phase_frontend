...
export const getTeacherDashboard = async (body) => {
    return await Axios.get(`https://api.myonlineedu.in//api/teacher/dashboard?userName=${body.userName}`, {
        headers: {
            'auth_token': localStorage.getItem('auth_token')
          }
    });
...
//     console.log(body, "@@##");
//     console.log("hii")
//     return await Axios.put(`https://api.myonlineedu.in///api/teacher/assign`, body, {headers})
// }
...
export const assignQuestionsToStudents = createAsyncThunk('teacher/assign', async (data) => {
    ...
    return await Axios.put(`https://api.myonlineedu.in/api/teacher/assign`, data, {headers})
