...
export const getStudentDashboard = async () => {
    return await Axios.get(`https://www.myonlineedu.in/api/student/dashboard?userName=${localStorage.getItem('studentUsername')}`);
...
export const getStudentTopCard = async () => {
    return await Axios.get(`https://www.myonlineedu.in/api/student/gettopcard?userName=${localStorage.getItem('studentUsername')}`);
...
export const getStudentClass = createAsyncThunk('student/studentClass', async (data) => {
    return await Axios.post('https://www.myonlineedu.in/api/student/class', data);
...
export const getExam = async (className) => {
    ...
    return await Axios.get(`https://www.myonlineedu.in/api/getexam?className=${className}`);
}
export const getChapters = async (subjectName) => {
    ...
    return await Axios.get(`https://www.myonlineedu.in/api/getchapter?subjectName=${subjectName}`);
}
export const getResults = async () => {
    // return await Axios.get(`http://localhost:9000/api/student/getresults?userName=${localStorage.getItem('studentUsername')}`);
    return await Axios.get(`https://www.myonlineedu.in/api/student/getresults?userName=${localStorage.getItem('studentUsername')}`);
}
export const getTeacherQuestions = async () => {
    ...
    return await Axios.get(`https://www.myonlineedu.in/api/student/teacher/question?userName=${localStorage.getItem('studentUsername')}`);
}
...
export const getChapterWisePerformance = async ({selectedChapter, selectedExam, selectedSubject}) => {
    ...
    return await Axios.get(`https://www.myonlineedu.in/api/student/performance/chapterwise?userName=${localStorage.getItem('studentUsername')}&exam=${selectedExam}&subject=${selectedSubject}&chapter=${selectedChapter}`);
}
...
export const getQuestions = createAsyncThunk('student/question', async (data) => {
    ...
    return await Axios.post('https://www.myonlineedu.in/api/student/question', data);
})
...
export const getQuestionBy_id = createAsyncThunk('student/question', async (data) => {
    ...
    return await Axios.post('https://www.myonlineedu.in/api/student/result/question', data);
})
...
export const saveResult = createAsyncThunk('student/question', async (data) => {
    ...
    return await Axios.post('https://www.myonlineedu.in/api/student/saveresult', data);
})
